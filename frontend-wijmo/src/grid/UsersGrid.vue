<template>
    <div style="max-height:80vh;">
        ...
        <UserViewQuery @search="search"></UserViewQuery>
        ...
        >
            <wj-flex-grid-filter :filterColumns="['uxid','tenantId','useStatus','pass','userName','createdBy','createTm','lastModiBy','lastModiTm','phoneNo','enterDt','managerId','rankId','departmentId',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="uxid" header="uxid" width="2*" :isReadOnly="true" align="center" />
            ...
            <wj-flex-grid-column binding="createdBy" header="createdBy" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="createTm" header="createTm" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="lastModiBy" header="lastModiBy" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="lastModiTm" header="lastModiTm" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="phoneNo" header="phoneNo" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="enterDt" header="enterDt" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="managerId" header="managerId" width="2*" :isReadOnly="true" align="center" />
...
<script>
import UserViewQuery from '../components/UserViewQuery.vue';
