<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-text>
            <Number label="Uxid" v-model="value.uxid" :editMode="editMode"/>
            ...
            <Date label="CreateTm" v-model="value.createTm" :editMode="editMode"/>
            <String label="LastModiBy" v-model="value.lastModiBy" :editMode="editMode"/>
            <Date label="LastModiTm" v-model="value.lastModiTm" :editMode="editMode"/>
            <String label="PhoneNo" v-model="value.phoneNo" :editMode="editMode"/>
            <String label="EnterDt" v-model="value.enterDt" :editMode="editMode"/>
...
export default {
    ...
    created(){
        ...
        client.connect().subscribe({
            ...
            const endpoint = "users."+ me.value.uxid +".get"
